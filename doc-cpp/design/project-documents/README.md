...
The radius and timestamp fields are independently optional and independently
validated. An invalid timestamp schedule disables Project Timeline navigation
without discarding a valid radius, and an invalid radius does not discard a
valid timestamp schedule.
