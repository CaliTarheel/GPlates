...
#include "PreferencesPaneAdvancedCapability.h"
...
GPlatesQtWidgets::PreferencesPaneAdvancedCapability::PreferencesPaneAdvancedCapability(
	...
	d_populating(false)
{
	...
	QLabel *heading_label = new QLabel(tr("<b>Feature Types shown in feature dialogs</b>"), this);
...
void
GPlatesQtWidgets::PreferencesPaneAdvancedCapability::populate_feature_types()
{
	d_populating = true;
...
void
GPlatesQtWidgets::PreferencesPaneAdvancedCapability::handle_item_changed(
		QListWidgetItem *)
{
	if (d_populating)
	{
...
void
GPlatesQtWidgets::PreferencesPaneAdvancedCapability::handle_filter_text_changed(
		const QString &text)
{
...
void
GPlatesQtWidgets::PreferencesPaneAdvancedCapability::show_all_feature_types()
{
...
void
GPlatesQtWidgets::PreferencesPaneAdvancedCapability::hide_all_feature_types()
{
...
void
GPlatesQtWidgets::PreferencesPaneAdvancedCapability::set_all_feature_types_checked(
		bool checked)
{
	d_populating = true;
	for (int row = 0; row < d_feature_type_list->count(); ++row)
...
void
GPlatesQtWidgets::PreferencesPaneAdvancedCapability::save_hidden_feature_types()
{
...
void
GPlatesQtWidgets::PreferencesPaneAdvancedCapability::update_summary()
{
