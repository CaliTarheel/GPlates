...
#ifndef GPLATES_QTWIDGETS_PREFERENCESPANEADVANCEDCAPABILITY_H
#define GPLATES_QTWIDGETS_PREFERENCESPANEADVANCEDCAPABILITY_H
...
{
	/**
	 * User-facing controls for optional advanced capabilities.
	 *
	 ...
	 */
	class PreferencesPaneAdvancedCapability :
			public QWidget
	{
		Q_OBJECT
	...
	public:
		...
		explicit
		PreferencesPaneAdvancedCapability(
...
#endif  // GPLATES_QTWIDGETS_PREFERENCESPANEADVANCEDCAPABILITY_H
